...
'''
txt = "У мене є супергерой, якого звати {myhero}. Він дуже {adj}. Коли {myhero} {action}, він {reaction}. А ще {myhero} має суперсилу. Це {superpower}."
print(txt.format(myhero = "Круасан", adj = "пухкий", action = "крутиться", reaction = "світиться", superpower = "вміння літати"))